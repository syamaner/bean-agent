...
class TestToolExecution:
    ...
    async def test_set_heat_valid(self, initialized_server):
        ...
        result = await call_tool("set_heat", {"level": 80})
    ...
    async def test_set_heat_invalid_increment(self, initialized_server):
        ...
        result = await call_tool("set_heat", {"level": 75})
    ...
    async def test_set_fan_valid(self, initialized_server):
        ...
        result = await call_tool("set_fan", {"speed": 60})
...
class TestFullRoastSimulation:
    ...
    async def test_full_roast_workflow(self):
        ...
        try:
            ...
            await call_tool("set_heat", {"level": 100})
            await call_tool("set_fan", {"speed": 30})
            ...
            await call_tool("set_heat", {"level": 90})
            await call_tool("set_fan", {"speed": 40})
            ...
            await call_tool("set_heat", {"level": 50})
            await call_tool("set_fan", {"speed": 60})
