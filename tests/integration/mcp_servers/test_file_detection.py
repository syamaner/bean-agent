...
async def test_server_initialization():
    ...
    Note: This is slow because it starts actual MCP server via stdio.
    """
    server_params = StdioServerParameters(
        command=sys.executable,
        args=["-m", "src.mcp_servers.first_crack_detection"],
...
async def test_list_tools():
    ...
    Note: This is slow because it starts actual MCP server.
    """
    server_params = StdioServerParameters(
        command=sys.executable,
        args=["-m", "src.mcp_servers.first_crack_detection"],
...
@pytest.mark.slow
@pytest.mark.asyncio
@pytest.mark.skip(reason="MCP SDK resource format issue - needs investigation")
